...
* [Как пользоваться](https://github.com/BorisPlus/otus_webpython_003/tree/regexp_routes#Как_пользоваться)
...
* Примеры
    ...
    * Пример _'Демонстрация базовых_возможностей фреймворка'_
    * Пример _'Приложение с передачей и оработкой допущенных параметров'_
