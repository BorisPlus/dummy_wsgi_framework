...
* [Примеры](https://github.com/BorisPlus/otus_webpython_003/tree/regexp_routes#Примеры)
    ...
    * [Пример _'Демонстрация базовых_возможностей фреймворка'_](https://github.com/BorisPlus/otus_webpython_003/tree/regexp_routes#Пример-Демонстрация-базовых-возможностей-фреймворка)
    ...
    * [Пример _'Приложение с двумя секретными страницами (Basic Auth)'_](https://github.com/BorisPlus/otus_webpython_003/tree/regexp_routes#Пример-Приложение-с-двумя-секретными-страницами-basic-auth)
...
### Пример _'Приложения с двумя секретными страницами (Basic Auth)'_
...
С целью возможной необходимости использования вами в вашем приложении параметров HTTP-запросов был реализован механизм назначения допустимых в маршрутах, необходимых для их контроллеров, параметров (в нотации "name=value"), с последующей их передачей дальше в представление (в той же нотации "name=value"). Это продемонстировано в примере ['Приложения с оработкой допущенных параметров'](https://github.com/BorisPlus/dummy-wsgi-framework/tree/master/examples_usage/app_get_allowed_params_from_route_link)
