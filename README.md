...
* реализация "как есть" - загрузка шаблона фреймворком, реализованная в ядре фреймворка;
* реализация с использованием "чего-то" самописного - загрузка шаблона и замена сответствующих лексем, если таковые переданы, возможным вашим собственным методом;
* реализация с использованием Jinja2 - загрузка шаблона и его обработка с помощью Jinja2.
